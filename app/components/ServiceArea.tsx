      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-6 text-5xl font-bold text-slate-900">
            Wij werken door heel Midden-Nederland
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg text-gray-600">
            M.S. Kracht Klusbedrijf is actief in diverse steden en regio's.
            Staat uw woonplaats er niet tussen? Neem gerust contact met ons op.
          </p>
        ...
        <div className="mt-16 rounded-3xl bg-blue-950 p-10 text-center text-white">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-blue-100">
            Geen probleem. Wij werken ook buiten deze regio.
            Neem vrijblijvend contact met ons op om de mogelijkheden
            te bespreken.
          </p>
