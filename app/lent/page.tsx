...
export const metadata: Metadata = {
  title: "Klusbedrijf Lent | Renovatie & Verbouwing | M.S. Kracht",
  description:
    "M.S. Kracht Klusbedrijf voor renovatie en verbouwing in Lent. Schilderwerk, badkamers, vloeren, isolatie en zolderrenovatie voor woningen.",
  alternates: {
    canonical: "https://www.krachtklusbedrijf-ms.nl/lent",
  },
};
      ...
      <section className="bg-slate-950 px-6 py-24 text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="mt-5 max-w-4xl text-4xl font-black leading-tight md:text-6xl">
            Klusbedrijf in Lent voor renovatie en verbouwing
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-gray-300 md:text-xl">
            Heeft u een klus, renovatie of verbouwing in Lent gepland?
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-3xl font-bold text-slate-900 md:text-4xl">
            Renovatie en klussen in Lent
          </h2>

          <p className="mt-6 text-lg leading-8 text-slate-700">
            Een woning renoveren of verbouwen vraagt om een goede
            voorbereiding. M.S. Kracht Klusbedrijf werkt voor klanten in Lent
            aan verschillende renovatie-, onderhouds- en
            verbouwingswerkzaamheden.
          </p>

          <p className="mt-5 text-lg leading-8 text-slate-700">
            Wilt u een ruimte opnieuw laten schilderen, een nieuwe vloer laten
            plaatsen of uw badkamer, zolder of isolatie aanpakken? We
            bespreken de werkzaamheden vooraf en kijken samen naar een
            praktische aanpak voor uw woning.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-white p-7 shadow-sm">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Vanuit Elst zijn wij actief in Lent en verschillende
                omliggende plaatsen.
              </p>
            </div>
          </div>
